...
import { FinanceRoot, StatCard, SectionCard, RangeSelector, Skeleton, FinanceErrorCard, PreviewBanner, Money, formatMoney } from './primitives.js'
...
import { deltaPct, formatDate } from '../format.js'
import type { FinanceClient } from '../client.js'
import type { Credit, Range } from '../types.js'
