 ...
 * and console never diverge. Preview data until `NEXT_PUBLIC_FINANCE_MODE=live`.
 */
    ...
    <div className="fin-shell">
      ...
      <div className="fin-shell-body">
        <div className="fin-container">
          ...
          <FinanceDashboard client={client} mode={config.mode} theme="dark" showTreasury standalone />
        </div>
      </div>
    </div>
  )
